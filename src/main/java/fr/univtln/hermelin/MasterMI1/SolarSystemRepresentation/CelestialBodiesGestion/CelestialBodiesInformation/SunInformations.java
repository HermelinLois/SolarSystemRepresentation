...
public class SunInformations extends CelestialBodiesInformation {
    ...
    private SunInformations(String name, float radius, float weight, String pathToTexture, float eccentricity, float E0, float orbitalRotationTime, float SelfRotationTime, float semiMajorAxis, float inclination) {
    ...
    public static void createSun(){
        ...
        numberOfSun++;
        new SunInformations("sun", 1f, 1f, "Textures/sun.jpg", 0.0167f, 0, 2 * 3.141592653589793f / 365.25f, 2 * 3.141592653589793f, 0, 0);
    }
}
